...
bot_token = environ.get("TOKEN", "8168976068:AAG3hYbOws-yxJgPCAY3HNodJOObQAsjlgA") 
api_hash = environ.get("HASH", "b976a44ccb8962b20113113f84aeebf6") 
api_id = int(environ.get("ID", "24602058"))
